...
$publish_directory="..\src\BRhodium\bin\$configuration\netcoreapp2.0\$runtime\publish"
...
& $warp --arch windows-x64 --input_dir $publish_directory --exec BRhodium.exe --output $publish_directory\BRhodium-$git_commit.exe
