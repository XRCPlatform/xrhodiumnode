...
publish_directory="../src/BRhodium/bin/${configuration}/netcoreapp2.0/${dotnet_runtime}/publish"
download_directory="/tmp"
warp="${warp_runtime}.warp-packer"
project_path="../src/BRhodium/BRhodium.csproj"
...
"${download_directory}/./${warp}" --arch $warp_runtime --input_dir $publish_directory --exec BRhodium --output ${publish_directory}/BRhodium-$git_commit
