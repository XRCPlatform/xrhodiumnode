...
namespace BRhodium.Bitcoin.Configuration
{
    ...
    public class NodeSettings
    {
            ...
            string agent = "BRhodiumBitcoin", string[] args = null, bool loadConfiguration = true)
        {
            ...
            if (this.Network == null)
            {
                ...
                this.Network = testNet ? Network.BRhodiumTest : regTest ? Network.BRhodiumRegTest : Network.BRhodiumMain;
            }

            // Setting the data directory.
            if (this.DataDir == null)
            {
                this.DataDir = this.CreateDefaultDataDirectories(Path.Combine("BRhodiumNode", this.Network.RootFolderName), this.Network);
            }
            else
            {
        ...
        public static void PrintHelp(Network network)
        {
            ...
            builder.AppendLine(" dotnet exec <BRhodium.BRhodiumD/BitcoinD.dll> [arguments]");
            builder.AppendLine();
