...
{
    /// <summary>
    /// Light wallet fixed fee policy used for BRhodium network.
    /// </summary>
    /// <seealso cref="https://github.com/BRhodiumproject/BRhodiumX/blob/master/src/wallet.cpp#L1437">BRhodiumX fee calculation.</seealso>
