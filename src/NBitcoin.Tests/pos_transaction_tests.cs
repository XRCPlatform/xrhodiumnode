...
namespace NBitcoin.Tests
{
    public class pos_transaction_tests
    {
        ...
        {
            ConcurrentChain chain = new ConcurrentChain(Network.BRhodiumMain);
        ...
        {
            Transaction tx = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        public void CanExtractTxOutDestinationEasily()
        {
            ...
            var secret = new BitcoinSecret("VHqBm5xVQvosc7u4dDwMmzbr8mL4KzZBn5VgqjunovgURtXBo5cV", Network.BRhodiumMain);

            var tx = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        public void CanSignTransaction()
        {
            ...
            var clone = tx.Clone(network: Network.BRhodiumMain);
            tx.Sign(Network.BRhodiumMain, key, false);
            AssertCorrectlySigned(tx, scriptPubKey);
            clone.Sign(Network.BRhodiumMain, key, true);
        ...
        public void CanBuildIssueColoredCoinWithMultiSigP2SH()
        {
            ...
            var bobSigned =
                new TransactionBuilder(Network.BRhodiumMain)
            ...
            var builder = new TransactionBuilder(Network.BRhodiumMain);
        ...
        public void CanBuildAnyoneCanPayTransaction()
        {
            ...
            var txBuilder = new TransactionBuilder(Network.BRhodiumMain);
            ...
            txBuilder = new TransactionBuilder(Network.BRhodiumMain);
        ...
        public void CanBuildShuffleColoredTransaction()
        {
            ...
            var repo = new NoSqlColoredTransactionRepository(new NoSqlTransactionRepository(Network.BRhodiumMain), new InMemoryNoSqlRepository(Network.BRhodiumMain));

            var init = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            ...
            var txBuilder = new TransactionBuilder(1, Network.BRhodiumMain);
            ...
            for (int i = 0; i < 20; i++)
            {
                txBuilder = new TransactionBuilder(i, Network.BRhodiumMain);
                txBuilder.StandardTransactionPolicy = RelayPolicy;
                tx = txBuilder
                    .AddCoins(satoshiBTC)
                    .AddCoins(cc)
        ...
        private void CanBuildColoredTransaction()
        {
            ...
            tx = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            ...
            catch (NotEnoughFundsException ex) //Not enough dust to send the change
            {
                ...
                Assert.Equal(gold.PubKey.Hash, change.ScriptPubKey.GetDestination(Network.BRhodiumMain));
                ...
                {
                    Assert.False(TxNullDataTemplate.Instance.CheckScriptPubKey(Network.BRhodiumMain, output.ScriptPubKey));
        ...
        public void CanBuildStealthTransaction()
        {
            ...
            TransactionBuilder builder = new TransactionBuilder(Network.BRhodiumMain);
            ...
            builder = new TransactionBuilder(Network.BRhodiumMain);
            builder.StandardTransactionPolicy = EasyPolicy;
            tx =
                builder
        ...
        void BitcoinStreamCoverageCore<TItem>(TItem[] input, BitcoinStreamCoverageCoreDelegate<TItem> roundTrip)
        {
            ...
            bs.ConsensusFactory = Network.BRhodiumMain.Consensus.ConsensusFactory;
        ...
        //    Transaction before = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        //    before = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        {
            Transaction after = before.Clone(network: Network.BRhodiumMain);
            Transaction after2 = null;

            MemoryStream ms = new MemoryStream();
            BitcoinStream stream = new BitcoinStream(ms, true);
            stream.TransactionOptions = TransactionOptions.None;
            stream.ConsensusFactory = Network.BRhodiumMain.Consensus.ConsensusFactory;
        ...
        public void CanBuildWitTransaction()
        {
            ...
            //P2WPKH
            previousTx = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            ...
            var signedTx2 = signedTx.WithOptions(TransactionOptions.None, Network.BRhodiumMain.Consensus.ConsensusFactory);
        ...
        public void CanCheckSegwitPubkey()
        {
            ...
            Assert.False(PayToWitTemplate.Instance.CheckScriptPubKey(Network.BRhodiumMain, a));
            a = new Script("1 033fbe0a2aa8dc28ee3b2e271e3fedc7568529ffa20df179b803bf9073c1");
            Assert.True(PayToWitTemplate.Instance.CheckScriptPubKey(Network.BRhodiumMain, a));
        ...
        public void CanEstimatedFeesCorrectlyIfFeesChangeTransactionSize()
        {
            ...
            var transactionBuilder = new TransactionBuilder(Network.BRhodiumMain);
        ...
        public void CanBuildTransaction()
        {
            ...
            var txBuilder = new TransactionBuilder(0, Network.BRhodiumMain);
            txBuilder.StandardTransactionPolicy = EasyPolicy;
            var tx = txBuilder
                .AddCoins(allCoins)
                .AddKeys(keys)
            ...
            txBuilder = new TransactionBuilder(0, Network.BRhodiumMain);
            txBuilder.StandardTransactionPolicy = EasyPolicy;
            tx = txBuilder
               .AddCoins(allCoins)
               .AddKeys(keys)
            ...
            signed1 = new TransactionBuilder(0, Network.BRhodiumMain)
                        .AddCoins(allCoins)
                        .AddKeys(keys[0])
                        .SignTransaction(tx);

            signed2 = new TransactionBuilder(0, Network.BRhodiumMain)
                        .AddCoins(allCoins)
                        .AddKeys(keys[1])
                        .SignTransaction(tx);
            ...
            tx = new TransactionBuilder(0, Network.BRhodiumMain)
                .CombineSignatures(signed1, signed2);
        ...
        {
            var network = Network.BRhodiumMain;
            ...
            var spendTransaction = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            ...
            var partiallySigned = spendTransaction.Clone(network: Network.BRhodiumMain);
            //... Now I can partially sign it using one private key:

            partiallySigned.Sign(Network.BRhodiumMain, privKeys[0], true);

            //the other private keys (note the "hex" result getting longer):
            partiallySigned.Sign(Network.BRhodiumMain, privKeys[1], true);
            ...
            partiallySigned = spendTransaction.Clone(network: Network.BRhodiumMain);
            partiallySigned.Sign(Network.BRhodiumMain, privKeys[2], true);
            partiallySigned.Sign(Network.BRhodiumMain, privKeys[0], true);
        ...
        private void AssertCorrectlySigned(Transaction tx, Script scriptPubKey, ScriptVerify scriptVerify = ScriptVerify.Standard)
        {
            ...
            {
                Assert.True(Script.VerifyScript(Network.BRhodiumMain, scriptPubKey, tx, i, null, scriptVerify));
            }
        }

        static StandardTransactionPolicy EasyPolicy = new StandardTransactionPolicy(Network.BRhodiumMain)
        {
        ...
        static StandardTransactionPolicy RelayPolicy = new StandardTransactionPolicy(Network.BRhodiumMain)
        {
            MaxTransactionSize = null,
            MaxTxFee = null,
        ...
        public void CanGetTransactionErrors()
        {
            ...
            var funding = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            ...
            var spending = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        private void CanCheckSegwitSig()
        {
            ...
            ScriptError error;
            Assert.True(toCheck.Inputs.AsIndexedInputs().Skip(0).First().VerifyScript(Network.BRhodiumMain, new Script("OP_HASH160 442afa4f034468652c571202da0bf277cb729def OP_EQUAL"), Money.Satoshis(100000), ScriptVerify.Mandatory, out error));
        }
        ...
        private static void CanCheckSegwitSigCore(Transaction tx, int input, Money amount, string scriptCodeHex = null)
        {
            ...
            {
                var param1 = PayToWitPubKeyHashTemplate.Instance.ExtractWitScriptParameters(Network.BRhodiumMain, tx.Inputs[input].WitScript);
                Assert.NotNull(param1);
                var param2 = PayToWitPubKeyHashTemplate.Instance.ExtractScriptPubKeyParameters(Network.BRhodiumMain, param1.PublicKey.GetSegwitAddress(Network.Main).Hash.ScriptPubKey);
            ...
            ScriptError err;
            var r = Script.VerifyScript(Network.BRhodiumMain, scriptCode, tx, 0, amount, out err);
            Assert.True(r);
        }
        ...
        public void CanParseWitTransaction()
        {
            ...
            Transaction tx = Transaction.Load(hex, Network.BRhodiumMain);
            ...
            var noWit = tx.WithOptions(TransactionOptions.None, Network.BRhodiumMain.Consensus.ConsensusFactory);
            ...
            ScriptError error;
            Assert.False(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BRhodiumMain, new Script("0 b7854eb547106248b136ca2bf48d8df2f1167588"), out error));
        ...
        private void bip143Test()
        {
            ...
            var h = Script.SignatureHash(Network.BRhodiumMain, new Script(Encoders.Hex.DecodeData("76a9141d0f172a0ecb48aee1be1f2687d2963ae33f71a188ac")), tx, 1, SigHash.All, Money.Satoshis(0x23c34600L), HashVersion.Witness);
        ...
        public void witnessHasPushSizeLimit()
        {
            ...
            Transaction spending = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            spending.AddInput(tx, 0);
            spending.Sign(Network.BRhodiumMain, bob, coin);
            ScriptError error;
            Assert.True(spending.Inputs.AsIndexedInputs().First().VerifyScript(Network.BRhodiumMain, coin, out error));
            spending.Inputs[0].WitScript = new WitScript(new[] { new byte[521] }.Concat(spending.Inputs[0].WitScript.Pushes).ToArray());
            Assert.False(spending.Inputs.AsIndexedInputs().First().VerifyScript(Network.BRhodiumMain, coin, out error));
        ...
        public void CanParseTransaction()
        {
            ...
            {
                string raw = test.Raw;
                Transaction tx = Transaction.Load(raw, Network.BRhodiumMain);
        ...
        private void PlayingWithSignatures()
        {
            ...
            var sig1 = (PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(Network.BRhodiumMain, script1).TransactionSignature.Signature);
            var sig2 = (PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(Network.BRhodiumMain, script2).TransactionSignature.Signature);
        ...
        public void CheckScriptCoinIsCoherent()
        {
            ...
            Assert.True(scriptCoin.GetHashVersion(Network.BRhodiumMain) == HashVersion.Original);
            ...
            Assert.True(scriptCoin.RedeemType == RedeemType.P2SH);
            Assert.True(scriptCoin.IsP2SH);
            Assert.True(scriptCoin.GetHashVersion(Network.BRhodiumMain) == HashVersion.Witness);
            ...
            Assert.Throws<ArgumentException>(() => ScriptCoin.Create(Network.BRhodiumMain, c, key.PubKey.ScriptPubKey.WitHash.ScriptPubKey));
        }
        ...
        public void CheckWitnessSize()
        {
            ...
            ScriptError error;
            Assert.True(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BRhodiumMain, coin1, ScriptVerify.Standard, out error));
            ...
            tx.Inputs[0].ScriptSig = Script.Empty;
            tx.Outputs.Add(new TxOut(Money.Zero, new Script(OpcodeType.OP_TRUE)));
            Assert.False(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BRhodiumMain, coin1, ScriptVerify.Standard, out error));
                ...
                foreach (var flag in new[] { SigHash.Single, SigHash.None, SigHash.All })
                {
                    foreach (var anyoneCanPay in new[] { true, false })
                    {
                        ...
                        foreach (var modification in new[] { HashModification.NoModification, HashModification.Modification, HashModification.Invalid })
                        {
                            ...
                            Transaction txx = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
                            ...
                            TransactionBuilder builder = new TransactionBuilder(Network.BRhodiumMain);
                            builder.SetTransactionPolicy(new StandardTransactionPolicy(Network.BRhodiumMain)
                            {
                                CheckFee = false,
                            ...
                            {
                                var clone = result.Clone(network: Network.BRhodiumMain);
                            ...
                            var sig = PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(Network.BRhodiumMain, signedInput.WitScript == WitScript.Empty ? signedInput.ScriptSig : signedInput.WitScript.ToScript()).TransactionSignature;
                            if (modification != HashModification.Invalid)
                            {
                                signatures.Add(sig);
        ...
        {
            // test is disabled for now
            // todo: get test data for the BRhodium blockchain
            ...
            foreach (var test in tests)
            {
                ...
                Transaction tx = Transaction.Load((string)test[1], Network.BRhodiumMain);
                ...
                for (int i = 0; i < tx.Inputs.Count; i++)
                {
                    ...
                    var valid = Script.VerifyScript(Network.BRhodiumMain,
        ...
        private void tx_invalid()
        {
            ...
            foreach (var test in tests)
            {
                ...
                for (int i = 0; i < tx.Inputs.Count && fValid; i++)
                {
                    ...
                    fValid = Script.VerifyScript(Network.BRhodiumMain,
                       mapprevOutScriptPubKeys[tx.Inputs[i].PrevOut],
                       tx,
                       i,
                       mapprevOutScriptPubKeysAmount.TryGet(tx.Inputs[i].PrevOut),
        ...
        public void test_Get()
        {
            ...
            Transaction t1 = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            ...
            Assert.True(StandardScripts.AreInputsStandard(Network.BRhodiumMain, t1, coins));
        ...
        {
            Transaction[] dummyTransactions = Enumerable.Range(0, 2).Select(_ => Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction()).ToArray();
            ...
            coinsRet.AddTransaction(Network.BRhodiumMain.Consensus, dummyTransactions[0], 0);
            ...
            coinsRet.AddTransaction(Network.BRhodiumMain.Consensus, dummyTransactions[1], 0);
        ...
        {
            Transaction outputm = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            outputm.Version = 1;
            ...
            output = outputm.Clone(network: Network.BRhodiumMain);
            ...
            Transaction inputm = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            inputm.Version = 1;
            outputm.Time = Utils.DateTimeToUnixTime(posTimeStamp);
            ...
            input = inputm.Clone(network: Network.BRhodiumMain);
        ...
        private static TransactionBuilder CreateBuilder(CKeyStore keystore, Transaction txFrom)
        {
            ...
            var builder = new TransactionBuilder(Network.BRhodiumMain)
            {
                StandardTransactionPolicy = new StandardTransactionPolicy(Network.BRhodiumMain)
                {
                    CheckFee = false,
                    MinRelayTxFee = null,
#if !NOCONSENSUSLIB
        ...
        {
            Transaction inputi = input.Clone(network: Network.BRhodiumMain);
            ScriptEvaluationContext ctx = new ScriptEvaluationContext(Network.BRhodiumMain);
        ...
        void ReplaceRedeemScript(TxIn input, Script redeemScript)
        {
            ...
            ctx.EvalScript(input.ScriptSig, Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction(), 0);
            var stack = ctx.Stack;
        ...
        public void test_witness()
        {
            ...
            output1 = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            output2 = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            Transaction input1, input2;
            input1 = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
            input2 = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        public void test_IsStandard()
        {
            ...
            Transaction t = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
