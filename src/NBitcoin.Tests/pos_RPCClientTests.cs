...
namespace NBitcoin.Tests
{
    ...
    {
        public static bool noClient = !Process.GetProcesses().Any(p => p.ProcessName.Contains("BRhodium"));
        ...
        public void InvalidCommandSendRPCException()
        {
            ...
            using (var builder = NodeBuilderBRhodium.Create())
            {
        ...
        public void CanGetGenesisFromRPC()
        {
            ...
            using (var builder = NodeBuilderBRhodium.Create())
            {
                ...
                Assert.Equal(Network.BRhodiumMain.GetGenesis().GetHash().ToString(), actualGenesis);
                //Assert.Equal(Network.BRhodiumMain.GetGenesis().GetHash(), rpc.GetBestBlockHash());
            }
        }
        ...
        public void CanGetRawMemPool()
        {
            ...
            using (var builder = NodeBuilderBRhodium.Create())
            {
                CoreNodeBRhodium node = builder.CreateNode();
        ...
        public void CanGetBlockFromRPC()
        {
            ...
            using (var builder = NodeBuilderBRhodium.Create())
            {
                ...
                AssertEx.CollectionEquals(Network.BRhodiumMain.GetGenesis().Header.ToBytes(), response.ToBytes());

                response = rpc.GetBlockHeader(0);
                Assert.Equal(Network.BRhodiumMain.GenesisHash, response.GetHash());
            }
        }
        ...
        //        builder.StartAll();
        //        Key key = new Key();
        //        rpc.ImportAddress(key.PubKey.GetAddress(Network.BRhodiumMain), TestAccount, false);
        ...
        //        var network = ((string)test[1]) == "Main" ? Network.BRhodiumMain : Network.BRhodiumMain;
...
@"{
    ...
    ""spendable"" : true
         ...
         * TODO: Consider importing to FN.
            ...
            using (var builder = NodeBuilderBRhodium.Create())
            {
                ...
                using(var node = nodeA.CreateNodeClient())
                {
                    ...
                    var peers = rpc.GetBRhodiumPeersInfoAsync().Result;
        ...
        public void CanAddNodes()
        {
            ...
            using (var builder = NodeBuilderBRhodium.Create())
            {
                CoreNodeBRhodium nodeA = builder.CreateNode();
                CoreNodeBRhodium nodeB = builder.CreateNode();
                builder.StartAll();
