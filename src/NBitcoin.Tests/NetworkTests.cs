...
namespace NBitcoin.Tests
{
    public class NetworkTests
    {
        ...
        [Fact]
        [Trait("UnitTest", "UnitTest")]
        public void BRhodiumMainIsInitializedCorrectly()
        {
            ...
            Assert.Equal("BRhodiumMain", network.Name);
            Assert.Equal(Network.BRhodiumRootFolderName, network.RootFolderName);
            Assert.Equal(Network.BRhodiumDefaultConfigFilename, network.DefaultConfigFilename);
            ...
            Assert.Equal(Network.BRhodiumMaxTimeOffsetSeconds, network.MaxTimeOffsetSeconds);
            Assert.Equal(Network.BRhodiumDefaultMaxTipAgeInSeconds, network.MaxTipAge);
        ...
        [Fact]
        [Trait("UnitTest", "UnitTest")]
        public void BRhodiumTestnetIsInitializedCorrectly()
        {
            ...
            Assert.Equal("BRhodiumTest", network.Name);
            Assert.Equal(Network.BRhodiumRootFolderName, network.RootFolderName);
            Assert.Equal(Network.BRhodiumDefaultConfigFilename, network.DefaultConfigFilename);
        ...
        [Fact]
        [Trait("UnitTest", "UnitTest")]
        public void BRhodiumRegTestIsInitializedCorrectly()
        {
            ...
            Assert.Equal("BRhodiumRegTest", network.Name);
            Assert.Equal(Network.BRhodiumRootFolderName, network.RootFolderName);
            Assert.Equal(Network.BRhodiumDefaultConfigFilename, network.DefaultConfigFilename);
