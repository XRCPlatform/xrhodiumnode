...
namespace BRhodium.Bitcoin.Features.MemoryPool
{
    ...
    public class MempoolValidator : IMempoolValidator
    {
        ...
        /// </summary>
        /// <seealso cref = "MempoolSettings" />
        public const int DefaultAncestorSizeLimit = 404;
        ...
        /// </summary>
        /// <seealso cref = "MempoolSettings" />
        public const int DefaultDescendantSizeLimit = 404;
        ...
        public static int GetTransactionWeight(Transaction tx, PowConsensusOptions consensusOptions)
        {
            return tx.GetSerializedSize(
                       (ProtocolVersion)
                       ((uint)ProtocolVersion.XRC_PROTOCOL_VERSION | consensusOptions.SerializeTransactionNoWitness),
                       SerializationType.Network) * (consensusOptions.WitnessScaleFactor - 1) +
                   tx.GetSerializedSize(ProtocolVersion.XRC_PROTOCOL_VERSION, SerializationType.Network);
        }
