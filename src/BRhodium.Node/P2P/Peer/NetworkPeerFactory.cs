...
namespace BRhodium.Node.P2P.Peer
{
    ...
    public interface INetworkPeerFactory
    {
        ...
        Task<INetworkPeer> CreateConnectedNetworkPeerAsync(string endPoint, ProtocolVersion myVersion = ProtocolVersion.XRC_PROTOCOL_VERSION, bool isRelay = true, CancellationToken cancellation = default(CancellationToken), NetworkPeerDisposer networkPeerDisposer = null);
        ...
        NetworkPeerServer CreateNetworkPeerServer(IPEndPoint localEndPoint, IPEndPoint externalEndPoint, ProtocolVersion version = ProtocolVersion.XRC_PROTOCOL_VERSION);
    ...
    public class NetworkPeerFactory : INetworkPeerFactory
    {
        ...
        public async Task<INetworkPeer> CreateConnectedNetworkPeerAsync(
            string endPoint,
            ProtocolVersion myVersion = ProtocolVersion.XRC_PROTOCOL_VERSION,
            bool isRelay = true,
        ...
        /// <inheritdoc/>
        public NetworkPeerServer CreateNetworkPeerServer(IPEndPoint localEndPoint, IPEndPoint externalEndPoint, ProtocolVersion version = ProtocolVersion.XRC_PROTOCOL_VERSION)
        {
