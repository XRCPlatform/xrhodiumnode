...
namespace BRhodium.Bitcoin.IntegrationTests.RPC
{
    ...
    public class GetStakingInfoActionTests
    {
        ...
        public void GetStakingInfo_StakingEnabled()
        {
            ...
            {
                IFullNode fullNode = BRhodiumBitcoinPosRunner.BuildStakingNode(dir.FolderName);
        ...
        public void GetStakingInfo_StartStaking()
        {
            using (var dir = TestDirectory.Create())
            {
                IFullNode fullNode = BRhodiumBitcoinPosRunner.BuildStakingNode(dir.FolderName, false);
