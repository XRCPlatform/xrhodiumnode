...
namespace BRhodium.Node.IntegrationTests
{
    public class ProofOfStakeSteps
    {
        ...
        {
            var newProofOfStakeNode = this.nodeGroupBuilder.CreateBRhodiumPosNode(nodeName)
                .Start()
                .NotInIBD()
                .Build();
        ...
        public void ProofOfWorkNodeWithWallet()
        {
            this.nodes = this.nodeGroupBuilder
                    .CreateBRhodiumPowMiningNode(this.PowMiner)
                    .Start()
                    .NotInIBD()
        ...
        {
            this.nodes[this.PowMiner].GenerateBRhodiumWithMiner(100);
        ...
        public void ProofOfStakeNodeWithWallet()
        {
            this.nodeGroupBuilder
                    .CreateBRhodiumPosNode(this.PosStaker)
                    .Start()
                    .NotInIBD()
        ...
        {
            this.nodes[this.PosStaker].GenerateBRhodiumWithMiner(Convert.ToInt32(this.nodes[this.PosStaker].FullNode.Network.Consensus.Option<PosConsensusOptions>().CoinbaseMaturity));
        }
