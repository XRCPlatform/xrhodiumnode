...
namespace BRhodium.Bitcoin.IntegrationTests.BlockStore
{
    public partial class RetrieveFromBlockStoreSpecification : BddSpecification
    {
        ...
        {
            this.transactionNode = this.builder.CreateBRhodiumPowNode();
        ...
        public void some_real_blocks_with_a_uint256_identifier()
        {
            ...
            this.blockIds = this.node.GenerateBRhodiumWithMiner(this.maturity + 1);
        }
        ...
        {
            this.blockWithTransactionId = this.node.GenerateBRhodiumWithMiner(1).Single();
            this.node.GenerateBRhodiumWithMiner(1);
            this.sharedSteps.WaitForNodeToSync(this.node, this.transactionNode);
        }
