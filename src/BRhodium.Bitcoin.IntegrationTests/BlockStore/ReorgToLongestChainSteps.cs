    ...
    public partial class ReorgToLongestChainSpecification
    {
        ...
        private void four_miners()
        {
            this.nodes = this.nodeGroupBuilder
                .BRhodiumPowNode(JingTheFastMiner).Start().NotInIBD().WithWallet(WalletZero, WalletPassword)
                .BRhodiumPowNode(Bob).Start().NotInIBD().WithWallet(WalletZero, WalletPassword)
                .BRhodiumPowNode(Charlie).Start().NotInIBD().WithWallet(WalletZero, WalletPassword)
                .BRhodiumPowNode(Dave).Start().NotInIBD().WithWallet(WalletZero, WalletPassword)
                .WithConnections()
