...
namespace BRhodium.Node.IntegrationTests.Mempool
{
    public partial class MempoolRelaySpecification
    {
        ...
        {
            this.nodeA = this.nodeBuilder.CreateBRhodiumPowNode();
            this.nodeB = this.nodeBuilder.CreateBRhodiumPowNode();
            this.nodeC = this.nodeBuilder.CreateBRhodiumPowNode();
        ...
        protected void nodeA_mines_coins_that_are_spendable()
        {
            ...
            this.nodeA.GenerateBRhodiumWithMiner(this.coinbaseMaturity + 1);
