...
namespace BRhodium.Bitcoin.Features.Wallet.Tests
{
    public class WalletSyncManagerTest : LogsTestBase
    {
        ...
        public WalletSyncManagerTest()
        {
            ...
            this.chain = new ConcurrentChain(Network.BRhodiumMain);
        ...
        public void Start_HavingPrunedStoreSetting_ThrowsWalletException()
        {
            ...
            var walletSyncManager = new WalletSyncManager(this.LoggerFactory.Object, this.walletManager.Object, this.chain, Network.BRhodiumMain,
        ...
        {
            this.storeSettings.Prune = false;
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(5, Network.BRhodiumMain);
        ...
        {
            var result = WalletTestsHelpers.GenerateChainAndBlocksWithHeight(5, Network.BRhodiumMain);
            this.chain = result.Chain;
            var blocks = result.Blocks;
            var walletSyncManager = new WalletSyncManagerOverride(this.LoggerFactory.Object, this.walletManager.Object, this.chain, Network.BRhodiumMain,
                this.blockStoreCache.Object, this.storeSettings, this.nodeLifetime.Object);
        ...
        {
            var result = WalletTestsHelpers.GenerateForkedChainAndBlocksWithHeight(5, Network.BRhodiumMain, 2);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(3, Network.BRhodiumMain);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(1, Network.BRhodiumMain);
