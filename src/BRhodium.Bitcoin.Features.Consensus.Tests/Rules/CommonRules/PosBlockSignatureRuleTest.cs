...
namespace BRhodium.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class PosBlockSignatureRuleTest : TestPosConsensusRulesUnitTestBase
    {
        ...
        {
            this.ruleContext.BlockValidationContext.Block = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateBlock();
        ...
        {
            this.ruleContext.BlockValidationContext.Block = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateBlock();
            this.ruleContext.BlockValidationContext.Block.Transactions.Add(Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction());

            var transaction = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction();
        ...
        {
            var block = Network.BRhodiumMain.Consensus.ConsensusFactory.CreateBlock();
            block.Transactions.Add(Network.BRhodiumMain.Consensus.ConsensusFactory.CreateTransaction());
