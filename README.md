...
Current version: 1.1.16 ([Gitlab link](https://gitlab.com/bitcoinrh/BRhodiumNode/tree/master_1.1.16))
...
```
    git clone -b master_1.1.16 https://gitlab.com/bitcoinrh/BRhodiumNode.git
    cd BRhodiumNode
```
