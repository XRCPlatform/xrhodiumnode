...
Current version: 1.1.17 ([Gitlab link](https://gitlab.com/bitcoinrh/BRhodiumNode/tree/master_1.1.17))
...
```
    git clone -b master_1.1.17 https://gitlab.com/bitcoinrh/BRhodiumNode.git
    cd BRhodiumNode
```
