...
Current version: 1.1.18 ([Gitlab link](https://gitlab.com/bitcoinrh/BRhodiumNode/tree/master_1.1.18))
...
```
    git clone -b master_1.1.18 https://gitlab.com/bitcoinrh/BRhodiumNode.git
    cd BRhodiumNode
```
